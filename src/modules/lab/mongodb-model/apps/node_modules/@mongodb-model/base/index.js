...
const fns = require('./lib/functions/fns');
const misc = require('./lib/functions/misc');
// const lab = require('./lib/lab');
// const Iam = require('../../../lib/command/router')

const Server = require('./lib/classes/Server')
const Client = require('./lib/classes/Client')
const Cli = require('./lib/classes/Cli')
const LinkedList = require('./lib/linkedList/singlyLinkedList/LinkedList')
const Node = require('./lib/linkedList/singlyLinkedList/Node')
...
class Base extends require("stream").Transform {
  ...
  constructor(...arrayOfObjects) {
    ...
    if(!this.Cli) this.Cli = Cli;
    if(!this.LinkedList) this.LinkedList = LinkedList;
   ...
   *
   */
   apiGet(url = 'https://jsonplaceholder.typicode.com/posts', options = {}, fn = (result, data) => {}, data = []){
   ...
   *
   */
   apiRequest(url = 'https://jsonplaceholder.typicode.com/posts', options, fn = (result, data) => {}, data = []){
