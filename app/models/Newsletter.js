...
|--------------------------------------------------------------------------------
|
| Newsletter extends the base model (Model) class and thus has everything
...
class Newsletter extends Model{
    ...
    |
    */
    constructor(dbOptions = {collection: 'newsletters', url: 'mongodb://localhost:27017', db: 'OnGo'},...options){
    ...
    */
    ...
    if(!this['hasOwnProperty']['collection']) this.collection = 'newsletters';
