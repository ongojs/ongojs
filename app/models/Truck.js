...
|--------------------------------------------------------------------------------
|
| Truck extends the base model (Model) class and thus has everything
...
class Truck extends Model{
    ...
    |
    */
    constructor(dbOptions = {collection: 'trucks', url: 'mongodb://localhost:27017', db: 'OnGo'},...options){
    ...
    */
    ...
    if(!this['hasOwnProperty']['collection']) this.collection = 'trucks';
