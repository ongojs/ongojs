...
|--------------------------------------------------------------------------------
|
| Car extends the base model (Model) class and thus has everything
...
class Car extends Model{
    ...
    |
    */
    constructor(dbOptions = {collection: 'cars', url: 'mongodb://localhost:27017', db: 'OnGo'},...options){
    ...
    */
    ...
    if(!this['hasOwnProperty']['collection']) this.collection = 'cars';
