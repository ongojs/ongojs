...
|--------------------------------------------------------------------------------
|
| Post extends the base model (Model) class and thus has everything
...
class Post extends Model{
    ...
    |
    */
    constructor(dbOptions = {collection: 'posts', url: 'mongodb://localhost:27017', db: 'OnGo'},...options){
    ...
    */
    ...
    if(!this['hasOwnProperty']['collection']) this.collection = 'posts';
